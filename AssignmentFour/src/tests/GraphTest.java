...
public class GraphTest {
    ...
    public void weightIs() throws Exception {
        ...
        assertTrue(graph.weightIs(res1, res7) == 0); // no edge exists
        assertTrue(graph.weightIs(res2, res4) != 0); // edge exists
        assertTrue(graph.weightIs(res4, res7) == 0); // no edge exists
        assertTrue(graph.weightIs(res7, res4) != 0); // edge exists
    ...
    public void getToVertices() throws Exception {
        ...
        assertTrue(container.compareTo(res2) == 0);
