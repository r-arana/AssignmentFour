 ...
 * Alright, so there are a few things that seem to make up the core of the ant colony optimization (ACO) algorithm.
...
public class AntColony{
    ...
    // How many ants would you like to send out?
    ...
    public void addVertex(Restaurant vertex){
    ...
    public void setPheromoneLevels(Restaurant vertex, int pheromoneLevel){
        int index = vertices.indexOf(vertex);
        pheromoneLevels.set(index, pheromoneLevel);
    }

    // Vertex should already be on our list
    public int getPheromoneLevels(Restaurant vertex){
        int index = vertices.indexOf(vertex);
